  ...
  const scene = {
    ...
    cameras: {
      main: {
        ...
        setRotation: vi.fn(),
        setAlpha: vi.fn(),
        shake: vi.fn((...args: unknown[]) => { const cb = args.find(a => typeof a === 'function') as ((c: unknown, p: number) => void) | undefined; cb?.(null, 1); }),
        flash: vi.fn((...args: unknown[]) => { const cb = args.find(a => typeof a === 'function') as ((c: unknown, p: number) => void) | undefined; cb?.(null, 1); }),
        fadeIn: vi.fn((...args: unknown[]) => { const cb = args.find(a => typeof a === 'function') as ((c: unknown, p: number) => void) | undefined; cb?.(null, 1); }),
        fadeOut: vi.fn((...args: unknown[]) => { const cb = args.find(a => typeof a === 'function') as ((c: unknown, p: number) => void) | undefined; cb?.(null, 1); }),
        zoomTo: vi.fn((...args: unknown[]) => { const cb = args.find(a => typeof a === 'function') as ((c: unknown, p: number) => void) | undefined; cb?.(null, 1); }),
        pan: vi.fn((...args: unknown[]) => { const cb = args.find(a => typeof a === 'function') as ((c: unknown, p: number) => void) | undefined; cb?.(null, 1); }),
